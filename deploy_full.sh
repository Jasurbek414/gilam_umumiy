...
cp -f "$REPO/backend/src/users/users.controller.ts" "$BACK/src/users/users.controller.ts"
...
cp -f "$REPO/frontend-app/src/components/layout/Topbar.tsx" "$FRONT/src/components/layout/Topbar.tsx"
mkdir -p "$FRONT/src/components/ui"
cp -f "$REPO/frontend-app/src/components/ui/Modal.tsx" "$FRONT/src/components/ui/Modal.tsx"
